...
describe('highlight.js', () => {
  describe('highlightError', () => {
    ...
    it('should error highlight before escaped >', () => {
      ...
      const v = highlightError(htmlInput, errorCharStart, errorLength);
      expect(v).toEqual(
        `<span class="hljs-keyword">if</span> (<span class="ion-diagnostics-error-chr">x</span> &gt; y) <span class="hljs-keyword">return</span>;`
      );
    });
    ...
    it('should error highlight after escaped <', () => {
      ...
      const v = highlightError(htmlInput, errorCharStart, errorLength);
      expect(v).toEqual(
        `<span class="hljs-keyword">if</span> (x &lt; <span class="ion-diagnostics-error-chr">y</span>) <span class="hljs-keyword">return</span>;`
      );
    });
    ...
    it('should error highlight first 3 chars', () => {
      ...
      const v = highlightError(htmlInput, errorCharStart, errorLength);
      expect(v).toEqual(
        `<span class="hljs-keyword"><span class="ion-diagnostics-error-chr">v</span><span class="ion-diagnostics-error-chr">a</span><span class="ion-diagnostics-error-chr">r</span></span> name: <span class="hljs-built_in">string</span> = <span class="hljs-string">'Ellie'</span>;`
      );
    });
    ...
    it('should error highlight second char', () => {
      ...
      const v = highlightError(htmlInput, errorCharStart, errorLength);
      expect(v).toEqual(
        `<span class="hljs-keyword">v<span class="ion-diagnostics-error-chr">a</span>r</span> name: <span class="hljs-built_in">string</span> = <span class="hljs-string">'Ellie'</span>;`
      );
    });
    ...
    it('should error highlight first char', () => {
      ...
      const v = highlightError(htmlInput, errorCharStart, errorLength);
      expect(v).toEqual(
        `<span class="hljs-keyword"><span class="ion-diagnostics-error-chr">v</span>ar</span> name: <span class="hljs-built_in">string</span> = <span class="hljs-string">'Ellie'</span>;`
      );
    });
  ...
  describe('typescript', () => {
    ...
    it('should replace typescript', () => {
      ...
      const v = highlight('typescript', sourceText, true).value;
      expect(v).toEqual(
        `<span class="hljs-keyword">var</span> name: <span class="hljs-built_in">string</span> = <span class="hljs-string">'Ellie'</span>;`
      );
    });
  });
  ...
  describe('html', () => {
    it('should replace html', () => {
      ...
      expect(v).toEqual(
        `<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">key</span>=<span class="hljs-string">"value"</span>&gt;</span>Text<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>`
      );
    });
  });
  ...
  describe('scss', () => {
    it('should replace scss', () => {
      ...
      expect(v).toEqual(
        `<span class="hljs-selector-class">.className</span> { <span class="hljs-attribute">color</span>: <span class="hljs-variable">$red</span>; }`
      );
    });
  });
});
