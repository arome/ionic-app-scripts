...
function buildComponentsMenu() {
  var items = [
    {
      href: 'http://ionicframework.com/docs/components/#overview',
      title: 'Overview'
    },
    {
      href: 'http://ionicframework.com/docs/components/#action-sheets',
      title: 'Action Sheets'
    },
    {
      href: 'http://ionicframework.com/docs/components/#alert',
      title: 'Alerts'
    },
    {
      href: 'http://ionicframework.com/docs/components/#badges',
      title: 'Badges'
    },
    {
      href: 'http://ionicframework.com/docs/components/#buttons',
      title: 'Buttons'
    },
    {
      href: 'http://ionicframework.com/docs/components/#cards',
      title: 'Cards'
    },
    {
      href: 'http://ionicframework.com/docs/components/#checkbox',
      title: 'Checkbox'
    },
    {
      href: 'http://ionicframework.com/docs/components/#datetime',
      title: 'DateTime'
    },
    { href: 'http://ionicframework.com/docs/components/#fabs', title: 'FABs' },
    {
      href: 'http://ionicframework.com/docs/components/#gestures',
      title: 'Gestures'
    },
    { href: 'http://ionicframework.com/docs/components/#grid', title: 'Grid' },
    {
      href: 'http://ionicframework.com/docs/components/#icons',
      title: 'Icons'
    },
    {
      href: 'http://ionicframework.com/docs/components/#inputs',
      title: 'Inputs'
    },
    {
      href: 'http://ionicframework.com/docs/components/#lists',
      title: 'Lists'
    },
    {
      href: 'http://ionicframework.com/docs/components/#loading',
      title: 'Loading'
    },
    {
      href: 'http://ionicframework.com/docs/components/#menus',
      title: 'Menus'
    },
    {
      href: 'http://ionicframework.com/docs/components/#modals',
      title: 'Modals'
    },
    {
      href: 'http://ionicframework.com/docs/components/#navigation',
      title: 'Navigation'
    },
    {
      href: 'http://ionicframework.com/docs/components/#popovers',
      title: 'Popover'
    },
    {
      href: 'http://ionicframework.com/docs/components/#radio',
      title: 'Radio'
    },
    {
      href: 'http://ionicframework.com/docs/components/#range',
      title: 'Range'
    },
    {
      href: 'http://ionicframework.com/docs/components/#searchbar',
      title: 'Searchbar'
    },
    {
      href: 'http://ionicframework.com/docs/components/#segment',
      title: 'Segment'
    },
    {
      href: 'http://ionicframework.com/docs/components/#select',
      title: 'Select'
    },
    {
      href: 'http://ionicframework.com/docs/components/#slides',
      title: 'Slides'
    },
    { href: 'http://ionicframework.com/docs/components/#tabs', title: 'Tabs' },
    {
      href: 'http://ionicframework.com/docs/components/#toast',
      title: 'Toast'
    },
    {
      href: 'http://ionicframework.com/docs/components/#toggle',
      title: 'Toggle'
    },
    {
      href: 'http://ionicframework.com/docs/components/#toolbar',
      title: 'Toolbar'
    }
  ];
